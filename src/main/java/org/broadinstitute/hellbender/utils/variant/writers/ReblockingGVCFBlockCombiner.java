    ...
    public void submit(final VariantContext variantContextToOutput) {
        ...
        for (final VariantContextBuilder builder : homRefBlockBuffer) {
            ...
            if (blockStart > variantEnd) {
                //break;  //this could be from a trimmed deletion
                //homRefBlockBuffer.add(homRefBlockBuffer.indexOf(builder), );
            ...
            if (blockStart < variantStart && !variantContextToOutput.getGenotype(0).isHomRef()) {
